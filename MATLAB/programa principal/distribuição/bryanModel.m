function [ds] = bryanModel(pyramid,levels,hierarchy,timestep,threshold,nc,a,gama)
precision=0.001;
for i=1:levels
...
for t=1:timestep
   ...
   while(~all(emptyList==0))
    ...
    ds=Distribuition(hierarchy,pyramid,ds,0.001,maxEfficiency,levels);
...
for i=1:levels
    ds(i,1:sizebin)=ds(i,1:sizebin)/pyramid(i).size;
end
